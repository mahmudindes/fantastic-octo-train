...
#[Route("/api/rest/v0/tags", name: 'rest_tag_')]
class RestTagController extends AbstractController
{
    ...
    ): Response
    {
        ...
        $result = $this->tagRepository->findByCustom($criteria, $orderBys, $limit, $offset);
        $totalCount = $this->tagRepository->countCustom($criteria);
    ...
    ): Response
    {
        ...
        $form = $this->createForm(TagType::class, $entity, ['csrf_protection' => false]);
        ...
        if (!$form->isValid()) {
            return $this->json(['message' => 'Tag data is not valid.'], Response::HTTP_BAD_REQUEST);
        }
    ...
    ): Response
    {
        ...
        if (!$result) {
            return $this->json(['message' => 'Tag does not exists.'], Response::HTTP_NOT_FOUND);
        }
